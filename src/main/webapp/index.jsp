...
<head>
    ...
    <title>Beauty of clothing - Modern E-Commerce</title>
...
<body>
    ...
    <header>
        <div class="container header-container">
            <a href="#" class="logo">lakshmi<span>Shop</span></a>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>SRI KRISHNA JANMASTAMI- 2025 <h1>
        ...
        <div class="products">
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="price">$20000 <span class="old-price">$1,199</span></div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="price">$649 <span class="old-price">$399</span></div>
    ...
    <footer>
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2023 lakshmiShop. All rights reserved.</p>
            </div>
        </div>
    </footer>
